...
<v-container fluid grid-list-md style="padding:5px">    
    ...
    <v-flex d-flex xs12 sm12 md12 lg6>
      ...
      <v-card class="pa-2 mb-3" v-if="song.youtubeId">
        ...
        <div style="position: relative; padding-bottom: 56.25%;">
          <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" :src="'https://www.youtube.com/embed/'+ song.youtubeId +'?autoplay=1'" frameborder="0" gesture="media" allow="autoplay;encrypted-media" ></iframe>
        </div>
      <br>
