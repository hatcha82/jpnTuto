...
function replaceAll(str, searchStr, replaceStr) {
 ...
 function listCrawlerCallBack(error, res, done) {
  if(error){
      ...
      var tables = document.querySelectorAll('body > table:nth-child(2) > tbody > tr:nth-child(4) > td:nth-child(3) table');
      ...
      tables.forEach(function(table){        
        ...
        var atag = table.querySelector('a')
...
async function start(){
  ...
  pagelistWD02 = [
  	'http://hukumusume.com/douwa/pc/world/itiran/sonota_001-020.htm'
  ,	'http://hukumusume.com/douwa/pc/world/itiran/sonota_021-040.htm'
  ,	'http://hukumusume.com/douwa/pc/world/itiran/sonota_041-060.htm'
  ,	'http://hukumusume.com/douwa/pc/world/itiran/sonota_061-080.htm'
  ,	'http://hukumusume.com/douwa/pc/world/itiran/sonota_081-100.htm'
  ,	'http://hukumusume.com/douwa/pc/world/itiran/sonota_101-120.htm'
  ,	'http://hukumusume.com/douwa/pc/world/itiran/sonota_move2012_2015.htm'
  ]
  
  pagelistES01 = [
    // 'http://hukumusume.com/douwa/pc/aesop/itiran/01gatu.htm'
  'http://hukumusume.com/douwa/pc/aesop/itiran/02gatu.htm'
// ,  'http://hukumusume.com/douwa/pc/aesop/itiran/03gatu.htm'
// ,  'http://hukumusume.com/douwa/pc/aesop/itiran/04gatu.htm'
// ,  'http://hukumusume.com/douwa/pc/aesop/itiran/05gatu.htm'
// ,  'http://hukumusume.com/douwa/pc/aesop/itiran/06gatu.htm'
// ,  'http://hukumusume.com/douwa/pc/aesop/itiran/07gatu.htm'
// ,  'http://hukumusume.com/douwa/pc/aesop/itiran/08gatu.htm'
// ,  'http://hukumusume.com/douwa/pc/aesop/itiran/09gatu.htm'
// ,  'http://hukumusume.com/douwa/pc/aesop/itiran/10gatu.htm'
// ,  'http://hukumusume.com/douwa/pc/aesop/itiran/11gatu.htm'
// ,  'http://hukumusume.com/douwa/pc/aesop/itiran/12gatu.htm'
  ]
  pagelistES01.forEach(function(link){
    addQueue(link)
  })
